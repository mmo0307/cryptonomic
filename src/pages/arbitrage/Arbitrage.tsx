...
import { Skeleton } from '@root/entities';
import { nanoid } from 'nanoid';

import { CoinRes, CoinsAttr, DataCoins, ResultCoins } from './models/arbitrage';
import {
  Block,
  BuyPrice,
  ContentBlock,
...
export const Arbitrage: React.FC = () => {
  ...
  const resultView: JSX.Element = useMemo(() => {
    const res: CoinRes = formattedCoins(
      filterCoins,
      coinsPair,
      sortParam,
      percentShow,
                ...
                res.BTC.map(item => (
                  <WrapperItem key={nanoid()}>
                    ...
                    <div>
                      ...
                      <ItemBlock>
                        by course:
                        <SellPrice>{item.strategy.sellPairCoin}</SellPrice>
                      </ItemBlock>
                    </div>
                    <div>
                      ...
                      <ItemBlock>
                        by course:
                        <SellPrice>{item.strategy.sellPairUsdt}</SellPrice>
                      </ItemBlock>
                    </div>
                    <ItemBlock>
                      <p>Profit:</p>
